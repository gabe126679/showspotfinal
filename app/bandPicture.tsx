...
export default function BandPicture({ route, navigation }) {
  ...
  const uploadImages = async () => {
    ...
    try {
      ...
      console.log('🎵 Updating band table with:', {
        band_id: band_id,
        band_profile_picture: uploadedUrls[0],
        band_secondary_pictures: uploadedUrls,
      ...
      Alert.alert('Success', successMessage, [
        { 
          text: 'View Profile', 
          onPress: () => navigation.navigate('BandPublicProfile', { band_id: band_id })
        }
      ]);
