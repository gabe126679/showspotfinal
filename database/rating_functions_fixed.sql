-- Fixed Rating Functions
-- These functions handle rating functionality with proper table aliases to avoid ambiguous column references
...
BEGIN
  RETURN EXISTS (
    ...
    AND ir.spotter_id = user_has_rated_entity.user_id
  );
END;
$$;
...
BEGIN
  ...
  AND ir.spotter_id = get_user_rating.user_id;
...
BEGIN
  ...
  INSERT INTO individual_ratings (entity_id, entity_type, spotter_id, rating_value)
