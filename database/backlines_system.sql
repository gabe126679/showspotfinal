-- Backlines System
-- Functions to handle backline applications, voting, and consensus for shows

-- 1. Function to add a backline application to a show
...
-- 2. Function to vote for a backline
...
-- 3. Function to update band consensus for backline
...
-- 4. Function to get backlines for a show with vote counts
...
-- 5. Function to check if user has voted for a specific backline
