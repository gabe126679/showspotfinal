-- Rating Functions with EXACT signatures shown in the error messages
-- Error shows: rate_entity(entity_id, entity_type, rating_value, user_id)
-- Notice: rating_value comes BEFORE user_id
...
DROP FUNCTION IF EXISTS rate_entity(UUID, TEXT, INTEGER, UUID);
...
-- 4. Function to submit a rating - IMPORTANT: rating_value comes BEFORE user_id!
