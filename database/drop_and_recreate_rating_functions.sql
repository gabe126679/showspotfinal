-- Drop existing functions first, then recreate with proper parameter names

-- Drop all existing rating functions
...
-- Now recreate with proper namespacing to avoid ambiguous column references
